...
- Beta measurement exports count subscription identity checks, failures, and resets as payment-readiness signals, but they do not include RevenueCat app user IDs, customer IDs, product IDs, or management URLs.
