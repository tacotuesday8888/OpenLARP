...
- A fail-closed Apple accessibility audit in CI across core onboarding, fact confirmation, Cooked evaluation, mission, quest, proof, feedback, and completion states; manual VoiceOver and device-layout review still remain release checks
